...
| Charlie Munger | Queued | *Poor Charlie’s Almanack* (the [Stripe Press edition](https://www.stripe.press/poor-charlies-almanack) is free online), Wesco Financial and Daily Journal meeting transcripts, “The Psychology of Human Misjudgment” | Mental models, inversion, and the psychology of misjudgment |
...
| Howard Marks | Queued | About 160 Oaktree client memos (1990–present, [public archive](https://www.oaktreecapital.com/insights/memos)), *The Most Important Thing*, *Mastering the Market Cycle* | Risk versus loss, market cycles, and second-level thinking |
...
| Nick Sleep and Qais Zakaria | Queued | The Nomad Investment Partnership letters, 2001–2014, [released free by the authors](https://igyfoundation.org.uk/) | Scale economies shared, destination analysis, and the cost of growth |
| Jeremy Grantham | Queued | GMO quarterly letters and Viewpoints ([public archive](https://www.gmo.com/americas/research-library/)) | Bubbles, mean reversion, and asset-class regimes |
